...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF34803D);
  late Color secondaryColor = const Color(0xFF0063A8);
  late Color tertiaryColor = const Color(0xFF39D2C0);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFC2C2C2);
  ...
  late Color fondoMenu = Color(0xFF001C2C);
  late Color customColor2 = Color(0xFF375D77);
  late Color customColor3 = Color(0xFF273640);
